...
//    all the elements with image1
    var images = document.querySelectorAll(".image1");
  
    // random positions for any image , anywhere in the page
  ...
  function happy() {
    ...
    absImg.style.display = "flex";
    var mainImg = document.getElementById("mainImg");
    mainImg.src = "./assets/happy1.gif";
  
    images.forEach(function (image) {
      image.src = "./assets/heart.gif";
    });
  }
  ...
  function yes() {
    if (counter >= 3) {
      ...
      alert("Kuch to Bhao khao meri cutieee. Sidhe yes mat bola karo...!!!");
    }
  }
